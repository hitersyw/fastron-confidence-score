function [t_train, t_test, l_train, l_test, Rn] = rvmBenchmark(base_path, dataset, n)
    % Benchmarking the performance of RVM on a dVRK testset. 
    % 
    % Inputs:
