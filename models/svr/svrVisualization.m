% Script for visualizing the training process of SVR on the dataset. 
...
%% Hyper-parameters;
box_constraint = 0.46416;
kernel_scale = 0.46416;         
epsilon = 0.018726;             
numIter = 1000;
maxIter = 10000; 
...
n = 1053;
 % (theta, y, x); Change this if the number of data-point changes; 
shape = [13, 9, 9];             

%% Load collision_score data
score_dict = load(sprintf(base_dir + "log/%s_n%d.mat", dataset, n));
...
% Uncomment this if you want auto-tuning the hyper-parameter.
