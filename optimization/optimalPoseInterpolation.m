% Script for finding the optimal base position based on three combined
% metrics of the dVRK datasets.Need to run dvrk_interpolation.m first to 
% save the interpolated models.
% To use this script, save the workspace produced by dvrk_interpolation.m, 
% and then change the model_path variable to load the variable.
...
% optimization
tic();
[x,fval,exitflag, output] = findPoseInterpolation(x0, n_init, -ones(1, 3), ones(1, 3), ...
