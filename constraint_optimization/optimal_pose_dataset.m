...
%% Load Dataset
[X_reach, y_reach] = load_dvrk4(input_spec, reachability_dataset, n, use_fastron, false);
[X_self_collision, y_self_collision] = load_dvrk4(input_spec, self_collision_dataset, n, use_fastron, false);
[X_env_collision, y_env_collision] = load_dvrk4(input_spec, environment_collision_dataset, n, use_fastron, false);
