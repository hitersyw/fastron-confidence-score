...
[X_reach_train, y_reach_train] = load_dvrk4(input_spec, reachability_dataset, n, use_fastron,false);
[X_self_collision_train, y_self_collision_train] = load_dvrk4(input_spec, self_collision_dataset, n, use_fastron, false);
[X_env_collision_train, y_env_collision_train] = load_dvrk4(input_spec, env_collision_dataset, n, use_fastron, false);
...
[X_reach_test, y_reach_test] = load_dvrk4(input_spec, reachability_dataset, n_test, use_fastron,false);
[X_self_collision_test, y_self_collision_test] = load_dvrk4(input_spec, self_collision_dataset, n_test, use_fastron,false);
[X_env_collision_test, y_env_collision_test] =  load_dvrk4(input_spec, env_collision_dataset, n_test, use_fastron,false);
% Safety Check;
