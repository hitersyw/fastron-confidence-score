...
| ------------------------------------------------------------ | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![Optimized Poses with equal weights](/figures/final_poses/optimized_1_1_1.png?raw=true) | ![Optimized Poses boosting reachability](/figures/final_poses/optimized_5_1_1.png?raw=true) | ![Optimized Poses boosting self-collision-free](/figures/final_poses/optimized_1_5_1.png?raw=true) | ![Optimized Poses boosting environment-collision-free](/figures/final_poses/optimized_1_1_5.png?raw=true) |
