...
% set scale bar
plot([-0.875; -0.825], [-0.05; -0.05], '-k', 'LineWidth', 2, 'Color', 'r');
plot([-0.825; -0.825], [-0.10; -0.05], '-k', 'LineWidth', 2, 'Color', 'r');
hold off
text(-0.85, -0.035, '5cm', 'HorizontalAlignment','center', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
text(-0.82, -0.075, '5cm', 'HorizontalAlignment','left', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);

export_fig figures/costmap/reachability.jpg -c[50,50,50,75]
...
text(-0.85, -0.035, '5cm', 'HorizontalAlignment','center', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
text(-0.82, -0.075, '5cm', 'HorizontalAlignment','left', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
export_fig figures/costmap/self_collision.jpg -c[50,50,50,75]
...
text(-0.85, -0.035, '5cm', 'HorizontalAlignment','center', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
text(-0.82, -0.075, '5cm', 'HorizontalAlignment','left', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
export_fig figures/costmap/env_collision.jpg -c[50,50,50,75]
...
text(-0.85, -0.035, '5cm', 'HorizontalAlignment','center', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
text(-0.82, -0.075, '5cm', 'HorizontalAlignment','left', 'VerticalAlignment','middle', 'Color', 'r', 'FontSize', 10);
export_fig figures/costmap/combined.jpg -c[50,50,50,75]
